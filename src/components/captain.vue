<template>
  <div class="owl captain regular" ref="owl" :class="[fly, fighting]" @touchstart="touchstart">
    ...
    <div class="body">
      ...
      <div class="clothes">
        <img src="../themes/images/skin/captain-clothes.png" alt="">
      </div>
      <div class="hat">
...
<style lang="less" scoped>
  ...
  @import "../themes/style/captain.less";
</style>